function [Kmat1,P,Q,R]=question3(initial)
...
figure(1)
plot(Kmat1,table(:,i),linewidth=2)
set(gca,'XMinorTick','on','YMinorTick','on')
title("Newton's method 3(a)-(c)",fontsize=20)
legend("(a)Bni=0","(b)Bni=1","(c)Bni=10",fontsize=20)
